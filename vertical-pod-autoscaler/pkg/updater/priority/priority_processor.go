...
// PriorityProcessor calculates priority of pod updates.
...
// NewProcessor return new default PriorityProcessor
...
func (d *defaultPriorityProcessor) GetUpdatePriority(pod *apiv1.Pod, vpa *vpa_types.VerticalPodAutoscaler,
	recommendation *vpa_types.RecommendedPodResources) podPriority {
